 ...
 * 
 */
public class BuyPic extends Page {
    ...
    public BuyPic(Long id, Long buyId, String imgUrl, Boolean isFirst, Boolean isValid, Date createTime, Timestamp updateTime, Long createUserId, Long operatorId) {
        super();
        this.id = id;
        this.buyId = buyId;
        this.imgUrl = imgUrl;
