...
<script type="text/javascript" src="${ctx }/js/user/info/my_buy_down_publish.js"></script>
</head>
...
<ul class="listTab">
	<li><a href="${ctx }/user/buy/my_buy_list/"><span>供货中</span></a></li>
	<li class="selected"><a href="${ctx }/user/buy/my_down_list/"><span>已下架</span></a></li>
