    ...
    <form method="post" id="form-publish">
        ...
        <div id="sec-prod">
            ...
            <div class="bd_main">
                ...
                <div class="item">
                	<i class="asterisk">*</i>
                    <span class="name">采购量：</span>
                    <input type="text" placeholder="请输入数字" class="tex" name="quantity">
                    <select class="set3" name="buyUnitId">
